...
def main():
    # 原始图像路径
    img_path = './lena512color.png'
    # 加密密钥参数列表
    key = [0.123456789010, 0.234578900, 0.3456789012, 0.245789012,
           0.4567890124, 0.5678901234, 0.6789012346, 0.7890123456, 0.6890123450]
    new_key = Generate_Key(img_path, key)
    # 原始图像
    img = cv2.imread(img_path)[:, :, (2, 1, 0)]
    # 加密后的图像
    img_encrypt = encrypt(img_path, new_key)
    cv2.imwrite('./lena512color_encrypt.png', img_encrypt)
    decrypt_path = './lena512color_encrypt.png'
    # 正确密钥解密图像
